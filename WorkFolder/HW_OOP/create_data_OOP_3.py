...
class DataGenerator:
    def __init__(self, grp_num, teach_num, subj_num, stud_num, mark_num):
        ...
        self.fake = Faker("uk-UA")

    def _generate_data(self, generator):
    ...
    def export_groups_data(self):
        groups_data_generator = self._generate_data(self.generate_groups_data)
    ...
    def export_teachers_data(self):
        teachers_data_generator = self._generate_data(self.generate_teachers_data)
    ...
    def export_subjects_data(self):
        subjects_data_generator = self._generate_data(self.generate_subjects_data)
    ...
    def export_students_data(self):
        students_data_generator = self._generate_data(self.generate_students_data)
    ...
    def export_grades_data(self):
        grades_data_generator = self._generate_data(self.generate_grades_data)
